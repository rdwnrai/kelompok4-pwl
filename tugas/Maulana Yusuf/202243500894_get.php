    ...
    <div class="flex-1 p-6 ml-0 md:ml-0">
        <div class="glass-dark rounded-2xl p-8 card-hover">
            <div class="text-white">
                <h2 class="text-primary-400 text-2xl font-semibold mb-6">FORM METHOD GET</h2>
                <div class="bg-white/10 rounded-lg p-6">
                    ...
                    if (isset($_GET["ok"])) {
                        ...
                        echo '<p class="text-green-300">Nama: ' . htmlspecialchars($_GET["nama"]) . '</p>';
                        echo '<p class="text-green-300">Umur: ' . htmlspecialchars($_GET["umur"]) . '</p>';
                        echo '</div>';
                    }
                    ?>
                </div>
